...
router.get('/autoposting',function(req,res){
    res.locals = { title: 'Auto-Posting'};
    res.render('Autoposting/autoposting');
})

router.get('/leaddash',function(req,res){
    res.locals = { title: 'Lead'};
    res.render('Lead/lead');
})

router.get('/autopostingscheduler',function(req,res){
    res.locals = { title: 'Scheduler'};
    res.render('Autopostingscheduler/autopostingscheduler');
})
// Calendar
